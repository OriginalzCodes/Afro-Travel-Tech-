    ...
    <main className="min-h-screen bg-neutral-50 pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="mb-12">
          ...
          <p className="text-xl text-neutral-600 font-light max-w-2xl mb-12">
            Discover the best Afro-centric events, tours, and culinary experiences across Europe.
          </p>
          
          <div className="bg-white p-4 rounded-3xl shadow-sm border border-neutral-100 mb-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <button className="flex items-center gap-2 px-6 py-2.5 rounded-full bg-white border border-neutral-200 text-neutral-600 font-semibold hover:border-neutral-900 hover:text-neutral-900 transition-all w-full md:w-auto justify-center">
        ...
        {filteredExperiences.length === 0 && (
          <div className="text-center py-24">
            ...
            <h3 className="text-2xl font-bold text-neutral-900 mb-2">No experiences found</h3>
